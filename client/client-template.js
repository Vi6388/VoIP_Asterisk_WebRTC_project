...
process.env.GOOGLE_APPLICATION_CREDENTIALS = '/opt/starlight/client/weconected-213102-d6ce095e0887.json';
  ...
  ws.on("message", function incoming(message) {
    ...
    switch (msg.event) {
      ...
      case "start":
        ...
        console.log(`activeChannel ${msg.start.streamSid}`);
        activeChannel = msg.start.streamSid;
      ...
      case "media":
        ...
        //THIS IS THE ONE recognizeStream.write(audioBuffer)
